            ...
            var options = {
                ...
                columns : [ [ {
                    ...
                    formatter : function(value, row) {
                        ...
                        var txt = '<sjc:auth url="/admin/userAgents/dailyLottery/edit"><a href="#" onClick="showWin('+ win +',' +url+ ','+ dat +')">编辑</a></sjc:auth>&nbsp;&nbsp;';
...
<div id="tb">
    ...
    <div>
        ...
        <sjc:auth url="/admin/userAgents/dailyLottery/edit"><a href="#" plain="true" icon="icon-add" class="easyui-linkbutton" onClick="showWin('#win','edit')">添加</a></sjc:auth>
    ...
    <div id="win">
        ...
        <form method="post" style="margin: 20px;" method="post">
            ...
            <input type="hidden" name="lotteryName" />
            ...
            <table class="formtable">
                ...
                <tr>
                    ...
                    <td>
                        <select name="lotteryId" >
                            <c:forEach items="${lotteryList}" var="bn">
                ...
                <tr>
                    ...
                    <td class="input-title">团队销量（元）</td>

            ...
            var options = {
                ...
                columns : [ [ {
                    ...
                    formatter : function(value, row) {
                        ...
                        var txt = '<sjc:auth url="/admin/userAgents/dividendLottery/edit"><a href="#" onClick="showWin('+ win +',' +url+ ','+ dat +')">编辑</a></sjc:auth>&nbsp;&nbsp;';
...
<div id="tb">
    ...
    <div>
        ...
        <sjc:auth url="/admin/userAgents/dividendLottery/edit"><a href="#" plain="true" icon="icon-add" class="easyui-linkbutton" onClick="showWin('#win','edit')">添加</a></sjc:auth>

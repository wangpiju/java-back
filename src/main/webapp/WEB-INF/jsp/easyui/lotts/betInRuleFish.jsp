			...
			<form id="form" action="list" method="post">
				<table>
			       <tr>
			          ...
			          <td> <sjc:auth url="/admin/lotts/betInRuleKill/add"><a href="#" plain="true" icon="icon-add" class="easyui-linkbutton" onClick="showWin('#win','add?type=1')">添加</a></sjc:auth></td>
	...
	<div id="win">
		<form method="post" style="margin: 20px;">
			...
			<table class="formtable">
				...
				<tr>
					<td class="input-title">养鱼金额</td>
					<td><input type="text" name="killAmount" /></td>
				</tr>
				<tr>
					<td class="input-title">养鱼次数</td>
				...
				<tr>
					<td class="input-title">养鱼最小倍数</td>
					<td><input type="text" name="killPriceMin" /></td>
				</tr>
				<tr>
					<td class="input-title">养鱼最大倍数</td>
					<td><input type="text" name="killPriceMax" /></td>
				</tr>
				<tr>
					<td class="input-title">已养鱼金额</td>
					<td><input type="text" name="hadKillAmount" /></td>
				</tr>
				<tr>
					<td class="input-title">已养鱼次数</td>

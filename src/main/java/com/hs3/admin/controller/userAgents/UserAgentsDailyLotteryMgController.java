...
import com.hs3.entity.userAgents.UserAgentsDailyLotteryMg;
...
@Controller
@Scope("prototype")
@RequestMapping({"/admin/userAgents/dailyLotteryMg"})
public class UserAgentsDailyLotteryMgController extends AdminController {
    ...
    public Object index(Date t1, Date t2) {
        ModelAndView mv = getView("/userAgents/userAgentsDailyLotteryMg");
        if (t1 != null) {
            if (t2 != null) {
    ...
    public Object list(String q_account, String q_programName, String q_begin, String q_end, String q_startTimeStr, String q_endTimeStr, Integer q_status) {
        ...
        List<UserAgentsDailyLotteryMg> list = this.userAgentsService.userAgentsDailyLotteryMgList(q_account, null, q_programName, q_begin, q_end, q_startTime, q_endTime, q_status, p);
    ...
    public Object edit(Integer id) {
        ...
        return userAgentsService.findUserAgentsDailyLotteryMg(id);
    }


    @ResponseBody
    @RequestMapping(value = {"/edit"}, method = {org.springframework.web.bind.annotation.RequestMethod.POST})
    public Object edit(UserAgentsDailyLotteryMg m) {
        ...
        userAgentsService.updateUserAgentsDailyLotteryMg(m);

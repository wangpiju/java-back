...
@Controller
@Scope("prototype")
@RequestMapping({"/admin/userAgents/dailyMg"})
public class UserAgentsDailyMgController extends AdminController {
    ...
    public Object index(Date t1, Date t2) {
        ModelAndView mv = getView("/userAgents/userAgentsDailyMg");
        if (t1 != null) {
            if (t2 != null) {
    ...
    public Object list(String q_account, String q_parentAccount, String q_programName, String q_begin, String q_end, String q_startTimeStr, String q_endTimeStr, Integer q_status) {
        ...
        List<UserAgentsDailyMg> list = this.userAgentsService.userAgentsDailyMgList(q_account, q_parentAccount, q_programName, q_begin, q_end, q_startTime, q_endTime, q_status, p);
    ...
    public Object edit(Integer id) {
        ...
        return userAgentsService.findUserAgentsDailyMg(id);
    }


    @ResponseBody
    @RequestMapping(value = {"/edit"}, method = {org.springframework.web.bind.annotation.RequestMethod.POST})
    public Object edit(UserAgentsDailyMg m) {
        ...
        userAgentsService.updateUserAgentsDailyMg(m);

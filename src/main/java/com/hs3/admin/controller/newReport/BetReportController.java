...
@Controller
@Scope("prototype")
@RequestMapping({"/admin/newReport/betReport"})
public class BetReportController extends AdminController {
    ...
    public Object index(Date t1, Date t2) {
        ModelAndView mv = getView("/newReport/betReport");
        if (t1 != null) {
            if (t2 != null) {
    ...
    public Object membershipReportNew(String lotteryId, Integer sorting, String startDateStr, String endDateStr) throws ParseException {
        ...
        List<BetReport> list = cpsReportService.betReport(lotteryIdArr, sorting, beginDate, endDate, p);
